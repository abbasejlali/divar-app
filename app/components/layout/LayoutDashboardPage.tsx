...
function LayoutDashboardPage({ children }: { children: React.ReactNode }) {
  return (
    <>
          ...
          <ul className="space-y-2 font-medium">
            ...
            <li>
              ...
              >
                ...
                <span className="flex-1 ms-3 whitespace-nowrap">آمار</span>
              </a>
            </li>
            <li>
              <Link
                href="/dashboard/add-ads"
                className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
              >
                <svg
