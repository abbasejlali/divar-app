...
// svgs
import { LogoMainSvg } from "@/public/imgs/CustomSvg";
...
function LayoutPage({ children }: { children: React.ReactNode }) {
  return (
    <div className=" container max-w-7xl mx-auto md:p-10 p-5 ">
      <header className="bg-white border-gray-200 dark:bg-gray-900 mt-4">
        <nav className="max-w-screen-xl flex flex-wrap items-center justify-between md:flex-row flex-row-reverse mx-auto py-4">
          ...
          <div
            ...
            id="navbar-cta"
          >
            <ul className="flex flex-col [&_a]:transition-all font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
              <li>
                <Link
                  href="/"
      ...
      {children}
      <footer className="bg-white dark:bg-gray-900" dir="ltr">
        <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
          <div className="md:flex md:justify-between">
            <div className="mb-6 md:mb-0">
              <Link
                ...
                className="flex items-center space-x-3 rtl:space-x-reverse"
              >
                <LogoMainSvg StyleSvg="w-[100px] h-[100px]" />
              </Link>
            </div>
            <div
              className="grid grid-cols-2 gap-8 sm:gap-36 sm:grid-cols-3"
              dir="rtl"
            >
              <div>
          ...
          <div className="sm:flex sm:items-center sm:justify-between">
            <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">
              ...
              <a
                href="https://github.com/abbasejlali"
                className="hover:text-gray-900 transition-all mr-1"
              >
                Abbas Ejlali
              </a>
              All Rights Reserved.
            ...
            <div className="flex mt-4 sm:justify-center sm:mt-0">
              ...
              <Link
                href="#"
                className="text-gray-500 transition-all hover:text-gray-900 dark:hover:text-white ms-5"
              >
                <svg
                  className="w-4 h-4"
                  aria-hidden="true"
